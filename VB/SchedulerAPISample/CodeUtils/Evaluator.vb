...
Namespace SchedulerAPISample
    Public MustInherit Class ExampleCodeEvaluator
        ...
        Protected Friend Function CompileAndRun(ByVal linesOfCode() As String, ByVal evaluationParameter As Object) As Boolean
            ...
            Dim referencesDX() As String = { AssemblyInfo.SRAssemblyData, GetModuleAssembly(), AssemblyInfo.SRAssemblySchedulerCore, AssemblyInfo.SRAssemblyPrintingCore, AssemblyInfo.SRAssemblyPrinting, AssemblyInfo.SRAssemblyScheduler, AssemblyInfo.SRAssemblyUtils, AssemblyInfo.SRAssemblyEditors, AssemblyInfo.SRAssemblyImages }
    ...
    Public MustInherit Class SchedulerExampleCodeEvaluator
        Inherits ExampleCodeEvaluator


        Protected Overrides Function GetModuleAssembly() As String
            Return AssemblyInfo.SRAssemblySchedulerCore
        End Function
        Protected Overrides Function GetExampleClassName() As String
            Return "SchedulerCodeResultViewer.ExampleItem"
        End Function
    End Class
    #Region "SchedulerCSExampleCodeEvaluator"
    Public Class SchedulerCSExampleCodeEvaluator
        Inherits SchedulerExampleCodeEvaluator

        Protected Overrides Function GetCodeDomProvider() As CodeDomProvider
            Return New Microsoft.CSharp.CSharpCodeProvider()
        End Function

        Private Const codeStart_Renamed As String = "using System;" & ControlChars.CrLf & "using DevExpress.XtraScheduler;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Drawing;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Services;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Native;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Xml;" & ControlChars.CrLf & "using System.Drawing;" & ControlChars.CrLf & "using System.Drawing.Drawing2D;" & ControlChars.CrLf & "using System.Windows.Forms;" & ControlChars.CrLf & "using DevExpress.Utils;" & ControlChars.CrLf & "using System.IO;" & ControlChars.CrLf & "using System.Diagnostics;" & ControlChars.CrLf & "using System.Xml;" & ControlChars.CrLf & "using System.Data;" & ControlChars.CrLf & "using System.Collections.Generic;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Globalization;" & ControlChars.CrLf & "namespace SchedulerCodeResultViewer { " & ControlChars.CrLf & "public class ExampleItem { " & ControlChars.CrLf & "        public static void Process(SchedulerControl scheduler) { " & ControlChars.CrLf & ControlChars.CrLf

        'const string codeBeforeClasses =
        '    "       \r\n }\r\n" +
        '    "    }\r\n";

        Private Const codeBeforeClasses_Renamed As String = "       " & ControlChars.CrLf & " }" & ControlChars.CrLf
    ...
    End Class
    #End Region
    #Region "SchedulerVbExampleCodeEvaluator"
    Public Class SchedulerVbExampleCodeEvaluator
        Inherits SchedulerExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "Imports Microsoft.VisualBasic" & ControlChars.CrLf & "Imports System" & ControlChars.CrLf & "Imports System.Linq" & ControlChars.CrLf & ControlChars.CrLf & "Imports DevExpress.XtraScheduler" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Drawing" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Services" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Native" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Xml" & ControlChars.CrLf & "Imports System.Drawing" & ControlChars.CrLf & "Imports System.Drawing.Drawing2D" & ControlChars.CrLf & "Imports System.Windows.Forms" & ControlChars.CrLf & "Imports DevExpress.Utils" & ControlChars.CrLf & "Imports System.IO" & ControlChars.CrLf & "Imports System.Diagnostics" & ControlChars.CrLf & "Imports System.Xml" & ControlChars.CrLf & "Imports System.Data" & ControlChars.CrLf & "Imports System.Collections.Generic" & ControlChars.CrLf & "Imports System.Globalization" & ControlChars.CrLf & "Namespace SchedulerCodeResultViewer" & ControlChars.CrLf & "	Public Class ExampleItem" & ControlChars.CrLf & "		Public Shared Sub Process(ByVal scheduler As SchedulerControl)" & ControlChars.CrLf & ControlChars.CrLf


        Private Const codeBeforeClasses_Renamed As String = ControlChars.CrLf & "		End Sub" & ControlChars.CrLf


        Private Const codeEnd_Renamed As String = ControlChars.CrLf & "End Class" & ControlChars.CrLf & " End Namespace" & ControlChars.CrLf
