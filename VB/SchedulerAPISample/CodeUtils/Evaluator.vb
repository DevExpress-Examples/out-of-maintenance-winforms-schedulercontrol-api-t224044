...
Namespace SchedulerAPISample
    ...
    Public Class SchedulerCSExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "using System;" & ControlChars.CrLf & "using DevExpress.XtraScheduler;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Drawing;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Services;" & ControlChars.CrLf & "using DevExpress.XtraScheduler.Native;" & ControlChars.CrLf & "using System.Drawing;" & ControlChars.CrLf & "using System.Drawing.Drawing2D;" & ControlChars.CrLf & "using System.Windows.Forms;" & ControlChars.CrLf & "using DevExpress.Utils;" & ControlChars.CrLf & "using System.IO;" & ControlChars.CrLf & "using System.Diagnostics;" & ControlChars.CrLf & "using System.Xml;" & ControlChars.CrLf & "using System.Data;" & ControlChars.CrLf & "using System.Collections.Generic;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Globalization;" & ControlChars.CrLf & "namespace SchedulerCodeResultViewer { " & ControlChars.CrLf & "public class ExampleItem { " & ControlChars.CrLf & "        public static void Process(SchedulerControl scheduler) { " & ControlChars.CrLf & ControlChars.CrLf
    ...
    Public Class SchedulerVbExampleCodeEvaluator
        ...
        Private Const codeStart_Renamed As String = "Imports Microsoft.VisualBasic" & ControlChars.CrLf & "Imports System" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Drawing" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Services" & ControlChars.CrLf & "Imports DevExpress.XtraScheduler.Native" & ControlChars.CrLf & "Imports System.Drawing" & ControlChars.CrLf & "Imports System.Drawing.Drawing2D" & ControlChars.CrLf & "Imports System.Windows.Forms" & ControlChars.CrLf & "Imports DevExpress.Utils" & ControlChars.CrLf & "Imports System.IO" & ControlChars.CrLf & "Imports System.Diagnostics" & ControlChars.CrLf & "Imports System.Xml" & ControlChars.CrLf & "Imports System.Data" & ControlChars.CrLf & "Imports System.Collections.Generic" & ControlChars.CrLf & "Imports System.Globalization" & ControlChars.CrLf & "Namespace SchedulerCodeResultViewer" & ControlChars.CrLf & "	Public Class ExampleItem" & ControlChars.CrLf & "		Public Shared Sub Process(ByVal document As Document)" & ControlChars.CrLf & ControlChars.CrLf


        Private Const codeBeforeClasses_Renamed As String = ControlChars.CrLf & "		End Sub" & ControlChars.CrLf


        Private Const codeEnd_Renamed As String = "End Class" & ControlChars.CrLf & " End Namespace" & ControlChars.CrLf
