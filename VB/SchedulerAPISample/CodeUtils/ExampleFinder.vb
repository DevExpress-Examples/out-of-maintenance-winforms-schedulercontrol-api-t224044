    ...
    Public MustInherit Class ExampleFinder
        ...
        Public Function ParseSouceFileAndFindRegionsWithExamples(ByVal groupName As String, ByVal sourceCode As String) As List(Of CodeExample)
            ...
            For Each match In matches
                ...
                result.Add(CreateSchedulerExample(groupName, regionName, exampleCode))

            Next match
            Return result
        End Function

        Protected Function CreateSchedulerExample(ByVal exampleGroup As String, ByVal regionName As String, ByVal exampleCode As String) As CodeExample
