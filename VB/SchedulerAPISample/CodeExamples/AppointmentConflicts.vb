...
Namespace SchedulerAPISample.CodeExamples
    Friend Class AppointmentConflicts
        Private Shared Sub AllowAppointmentConflictsEvent(ByVal scheduler As SchedulerControl)
            ...
            Dim apt1 As Appointment = scheduler.Storage.Appointments.CreateAppointment(AppointmentType.Normal, Date.Now, Date.Now.AddHours(2))
            apt1.ResourceId = scheduler.Storage.Resources(0).Id
            scheduler.Storage.Appointments.Add(apt1)
            Dim apt2 As Appointment = scheduler.Storage.Appointments.CreateAppointment(AppointmentType.Normal, Date.Now, Date.Now.AddHours(2))
