...
Namespace SchedulerAPISample.CodeExamples
    Friend Class SerializationExamples
        ...
        Private Shared Sub AppointmentDeserialization(ByVal scheduler As SchedulerControl)
            ...
            Dim xmlAppointment As String = "<Appointment Version=""1"" Start=""01/13/2016 04:22:00"" End=""01/13/2016 05:53:00"" Label=""5"" ResourceId=""3"" Status=""2"" Subject=""Meet Andrew Miller"" />"
