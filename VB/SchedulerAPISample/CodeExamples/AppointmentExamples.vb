...
Namespace SchedulerAPISample.CodeExamples
    Friend Class AppointmentExamples
        ...
        Shared Sub UseCustomFields(ByVal scheduler As SchedulerControl)
        ...
        '#Region "#@UseCustomFields"
        Shared Sub Storage_FilterAppointment(ByVal sender As Object, ByVal e As PersistentObjectCancelEventArgs)
