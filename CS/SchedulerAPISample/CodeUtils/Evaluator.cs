...
namespace SchedulerAPISample
{
    public abstract class ExampleCodeEvaluator
    {
        ...
        protected internal bool CompileAndRun(string[] linesOfCode, object evaluationParameter)
        {
            ...
            string[] referencesDX = new string[] {
                ...
                AssemblyInfo.SRAssemblyScheduler,
                AssemblyInfo.SRAssemblyUtils,
                AssemblyInfo.SRAssemblyEditors,
                AssemblyInfo.SRAssemblyImages
            };
    ...
    public abstract class SchedulerExampleCodeEvaluator : ExampleCodeEvaluator
    {
    ...
    public class SchedulerCSExampleCodeEvaluator : SchedulerExampleCodeEvaluator
    {
      ...
      "namespace SchedulerCodeResultViewer { \r\n" +
      "public class ExampleItem { \r\n" +
      "        public static void Process(SchedulerControl scheduler) { \r\n" +
      "\r\n";
    ...
    public class SchedulerVbExampleCodeEvaluator : SchedulerExampleCodeEvaluator
    {
      ...
      "Namespace SchedulerCodeResultViewer\r\n" +
      "	Public Class ExampleItem\r\n" +
      "		Public Shared Sub Process(ByVal scheduler As SchedulerControl)\r\n" +
      "\r\n";
