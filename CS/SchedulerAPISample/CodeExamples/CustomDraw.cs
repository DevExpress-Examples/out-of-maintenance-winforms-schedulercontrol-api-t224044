...
namespace SchedulerAPISample.CodeExamples
{
    class CustomDraw
    {
        ...
        static void CustomDrawResourceHeader(SchedulerControl scheduler)
        {
            ...
            ResourceStorage resStorage = scheduler.Storage.Resources;
        ...
        static void CustomDrawTimeCell(SchedulerControl scheduler)
        {
            ...
            scheduler.ActiveViewType = SchedulerViewType.Day;
            scheduler.GoToDate(new DateTime(DateTime.Today.Year, DateTime.Today.Month, 13));
        ...
        {
            // Create brushes.
            System.Drawing.Drawing2D.HatchBrush brickBrush =
                    new System.Drawing.Drawing2D.HatchBrush(System.Drawing.Drawing2D.HatchStyle.DiagonalBrick,
                        Color.LightYellow, Color.Firebrick);
            ...
            if (cell != null)
            {
                ...
                else if (cell.Interval.Start.Day == 13)
                {
